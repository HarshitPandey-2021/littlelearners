...
export default function Programs() {
  const programs = [
    ...
    },
    {
      ...
      description: 'Make numbers fun with interactive problem-solving',
      ageRange: '5-8 years',
    ...
    },
    {
      icon: Palette,
      title: 'Creative Arts',
      description: 'Express creativity through art, music, and storytelling',
      ageRange: '5-8 years',
    ...
    },
    {
      icon: Microscope,
      title: 'Curiosity Lab',
      description: 'Explore science through fun experiments and discovery',
      ageRange: '6-8 years',
